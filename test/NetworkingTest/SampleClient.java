 ...
 */
public class SampleClient implements Client, Runnable {
    public final ClientListener clientListener = new ClientListener();
    ...
    public AbstractPlayer opponent;
     ...
     */
    public SampleClient(Listener listener) {
     ...
     */
    public void move(String[] splitted) {
     ...
     */
    public void list(String[] splitted) {
     ...
     */
    public void gameOver(String[] splitted) {
        inGame = false;
        switch (splitted[1]) {
            case "DISCONNECT":
     ...
     */
    public void newGame(String[] splitted) {
        inQueue = false;
        inGame = true;
